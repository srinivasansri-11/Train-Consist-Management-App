...
public class TrainConsistManagementApp {
    ...
    public static void main(String[] args) {
        ...
        String trainIdRegex = "TRN-\\d{4}";      // Train ID must be TRN- followed by 4 digits
        String cargoCodeRegex = "PET-[A-Z]{2}";  // Cargo Code must be PET- followed by 2 uppercase letters
